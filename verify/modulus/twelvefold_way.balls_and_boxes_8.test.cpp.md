...
# :heavy_check_mark: modulus/twelvefold_way.balls_and_boxes_8.test.cpp
...
{% raw %}
```cpp
#line 1 "modulus/twelvefold_way.balls_and_boxes_8.test.cpp"
#define PROBLEM "http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_H"
#include <iostream>
...
#line 4 "modulus/twelvefold_way.balls_and_boxes_8.test.cpp"
using namespace std;
