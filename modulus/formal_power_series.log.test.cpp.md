...
data:
  ...
  bundledCode: "#line 2 \"modulus/formal_power_series.hpp\"\n#include <algorithm>\n\
    ...
    \    int n; scanf(\"%d\", &n);\n    vector<mint<MOD> > a(n);\n    REP (i, n) {\n\
    \        scanf(\"%d\", &a[i].value);\n    }\n\n    // solve\n    vector<mint<MOD>\
    \ > b = formal_power_series<mint<MOD> >(a).log(n).data();\n    b.resize(n);\n\n\
    \    // output\n    REP (i, n) {\n        printf(\"%d \", b[i].value);\n    }\n\
    \    printf(\"\\n\");\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: modulus/formal_power_series.log.test.cpp
layout: document
redirect_from:
- /verify/modulus/formal_power_series.log.test.cpp
- /verify/modulus/formal_power_series.log.test.cpp.html
