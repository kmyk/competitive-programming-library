...
* :warning: <a href="binary_search_float.hpp.html">a binary search on floating point numbers / 二分探索 (浮動小数点数) <small>(utils/binary_search_float.hpp)</small></a>
...
* :x: <a href="two_satisfiability.hpp.html">2-SAT ($O(N)$) <small>(utils/two_satisfiability.hpp)</small></a>
