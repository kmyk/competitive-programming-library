...
* :heavy_check_mark: <a href="../data_structure/link_cut_tree.hpp.html">Link-Cut tree (with commutative monoids, vertex set + path get) <small>(data_structure/link_cut_tree.hpp)</small></a>
