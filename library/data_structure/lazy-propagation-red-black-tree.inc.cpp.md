...
* <a href="{{ site.github.repository_url }}/blob/master/data_structure/lazy-propagation-red-black-tree.inc.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "data_structure/lazy-propagation-red-black-tree.inc.cpp"
/**
 * @note almost all operations are O(log N)
 */
template <class Monoid, class OperatorMonoid>
