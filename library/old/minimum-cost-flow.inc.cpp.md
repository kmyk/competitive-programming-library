...
# VerificationStatus.DEFAULT minimum-cost flow with primal-dual method <small>(old/minimum-cost-flow.inc.cpp)</small>

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#149603e6c03516362a8da23f624db945">old</a>
* <a href="{{ site.github.repository_url }}/blob/master/old/minimum-cost-flow.inc.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "old/minimum-cost-flow.inc.cpp"
template <class T>
struct edge { int to; T cap, cost; int rev; };
template <class T>
void add_edge(vector<vector<edge<T> > > & graph, int from, int to, T cap, T cost) {
