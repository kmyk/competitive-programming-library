...
* :warning: [a double-ended priority queue](library/data_structure/double-ended-priority-queue.inc.cpp.html)
...
* :warning: [a segment tree beats](library/data_structure/segment_tree_beats.hpp.html)
* :warning: [data_structure/skew-heap.inc.cpp](library/data_structure/skew-heap.inc.cpp.html)
* :warning: [the sliding window minimum algorithm](library/data_structure/sliding-window.inc.cpp.html)
...
### geometry
* :warning: [Andrew's Monotone Chain](library/geometry/a.inc.cpp.html)
...
* :warning: [compute the distances from root](library/graph/breadth-first-search.inc.cpp.html)
...
* :warning: [Dinic](library/graph/dinic.inc.cpp.html)
* :warning: [graph/dominator-tree.inc.cpp](library/graph/dominator-tree.inc.cpp.html)
* :warning: [euler tour](library/graph/euler-tour.inc.cpp.html)
* :warning: [graph/ford-fulkerson.inc.cpp](library/graph/ford-fulkerson.inc.cpp.html)
* :warning: [heavy light decomposition](library/graph/heavy_light_decomposition.inc.cpp.html)
* :warning: [lowest common ancestor with doubling](library/graph/lowest-common-ancestor-doubling.inc.cpp.html)
* :heavy_check_mark: [lowest common ancestor with \pm 1 RMQ and sparse table](library/graph/lowest_common_ancestor.hpp.html)
* :warning: [minimum-cost flow with primal-dual method](library/graph/minimum-cost-flow.inc.cpp.html)
...
* :warning: [strongly connected components decomposition, Kosaraju's algorithm](library/graph/strongly_connected_components.cpp.html)
...
* :warning: [fold a rooted tree (木DP)](library/graph/tree-dp.inc.cpp.html)
* :warning: [2-edge-connected components decomposition](library/graph/two-edge-connected-components.inc.cpp.html)
* :warning: [2-node-connected components decomposition](library/graph/two-node-connected-components.inc.cpp.html)
* :warning: [reverse a digraph](library/graph/utils.inc.cpp.html)
* :warning: [Warshall-Floyd algorithm](library/graph/warshall-floyd.inc.cpp.html)


### modulus
* :warning: [modulus/998244353.inc.cpp](library/modulus/998244353.inc.cpp.html)
* :warning: [the Bell number](library/modulus/bell-number.inc.cpp.html)
* :warning: [0^k + 1^k + 2^k + ... + (n - 1)^k](library/modulus/bernoulli-number.inc.cpp.html)
...
* :warning: [a program to make the table](library/modulus/factorial-embed.inc.cpp.html)
...
* :warning: [the baby-step giant-step](library/modulus/powmod.inc.cpp.html)
* :warning: [the Stirling number of the second kind](library/modulus/stirling-number-of-the-second-kind.inc.cpp.html)
* :warning: [labeled-N labeled-K any-f](library/modulus/twelvefold-way.inc.cpp.html)


### number
* :warning: [number/choose.inc.cpp](library/number/choose.inc.cpp.html)
* :warning: [extended gcd](library/number/extgcd.inc.cpp.html)
* :warning: [number/factoradic.inc.cpp](library/number/factoradic.inc.cpp.html)
* :warning: [(upward) fast zeta transformation](library/number/fast-mobius-transformation.inc.cpp.html)
...
* :warning: [enumerate primes in [2, n) with O(n log log n)](library/number/primes-small.inc.cpp.html)
...
* :warning: [compare substrings of a string with O(1) using suffix arrays](library/string/comparable-view.inc.cpp.html)
* :warning: [Morris-Pratt algorithm](library/string/knuth-morris-pratt.inc.cpp.html)
...
* :warning: [a rolling hash](library/string/rolling-hash.inc.cpp.html)
* :warning: [suffix array](library/string/suffix-array.inc.cpp.html)
...
* :warning: [cumulative sum](library/utils/cumulative-sum.inc.cpp.html)
...
* :warning: [the doubling technique](library/utils/doubling.inc.cpp.html)
* :warning: [utils/dsu_on_tree.hpp](library/utils/dsu_on_tree.hpp.html)
* :warning: [upward fast zeta transform on primes](library/utils/fast_zeta_transform.hpp.html)
...
* :warning: [minimum excluded value](library/utils/mex.inc.cpp.html)
* :warning: [for given a and c, make b s.t. a < b < c](library/utils/midpoint.inc.cpp.html)
...
* :warning: [the extended Mo's algorithm](library/utils/rollback-square-decomposition.inc.cpp.html)
