...
data:
  ...
  bundledCode: "#line 1 \"data_structure/segment_tree_beats.DSL_2_I.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_I\"\
    ...
    \                default: assert (false);\n            }\n        }\n    }\n};\n\
    #line 3 \"data_structure/segment_tree_beats.DSL_2_I.test.cpp\"\n\n#line 3 \"hack/fastio.hpp\"\
    \n#include <cstdio>\n#include <string>\n#include <type_traits>\n\ntemplate <class\
    ...
    \ i] + '0');\n}\n#line 8 \"data_structure/segment_tree_beats.DSL_2_I.test.cpp\"\
    \n\nint main() {\n    int n = in<int>();\n    int q = in<int>();\n\n    segment_tree_beats\
    \ beats(n);\n\n    while (q --) {\n        int ty = in<int>();\n        int l\
    \ = in<int>();\n        int r = in<int>();\n        ++ r;\n        if (ty == 0)\
  ...
  verifiedWith: []
documentation_of: data_structure/segment_tree_beats.DSL_2_I.test.cpp
layout: document
redirect_from:
- /verify/data_structure/segment_tree_beats.DSL_2_I.test.cpp
- /verify/data_structure/segment_tree_beats.DSL_2_I.test.cpp.html
