...
data:
  ...
  bundledCode: "#line 1 \"data_structure/link_cut_tree.vertex_set_path_composite.test.cpp\"\
    ...
    \      mint<MOD> b_i = in<int32_t>();\n        lct.vertex_set(i, make_pair(a_i,\
...
layout: document
redirect_from:
- /verify/data_structure/link_cut_tree.vertex_set_path_composite.test.cpp
- /verify/data_structure/link_cut_tree.vertex_set_path_composite.test.cpp.html
